...
## Purpose
Defines how the Firebot script is built, packaged, registered, and torn down so that Firebot can load exactly one self-contained file and cleanly start and stop the script.
